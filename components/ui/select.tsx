...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "px-3.5 py-2 text-sm text-content-primary shadow-sm",
      "placeholder:text-content-secondary",
      "transition-all duration-200",
      "hover:border-border-primary hover:bg-surface-secondary",
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 text-content-secondary shrink-0 transition-transform duration-200" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ref={ref}
    className={cn(
      "flex cursor-default items-center justify-center py-1 text-content-secondary",
      className
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "px-3 py-1.5 text-xs font-semibold text-content-secondary uppercase tracking-wider",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "rounded-xl py-2 pl-3 pr-9 text-sm text-content-primary",
