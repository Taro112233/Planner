// app/api/board/tasks/[taskId]/priority/route.ts
// Task Priority Controller — Layer 1 (HTTP only)
//
// PATCH /api/board/tasks/[taskId]/priority — change task priority (TaskPage).
...
import { updateTaskPriority } from '@/services/board.service';
...
export async function PATCH(
  ...
  try {
    ...
    const task = await updateTaskPriority(organizationId, taskId, parsed.data.priority, actor);
    ...
    console.error('[PATCH /api/board/tasks/[taskId]/priority]', error);
